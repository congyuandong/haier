...
import com.legoo.haier.AsyncTask.AgreementAsyncTask;
...
public class AgreementActivity extends NavigationActivity
{
	...
	private void initTask()
	{
		...
		_taskArchon.setOnLoadedListener(new OnLoadedListener() 
		{
			...
			{
				initWebData((AgreementModel) ((ModelEvent) event).getModel());
			}
		});
	...
	{
        getNavigation().setTitle(getString(R.string.navigation_title_agreement));
	}
	
	private void initWebData(AgreementModel model)
	{
		_webView.loadDataWithBaseURL(null, model.getContent(), WEB_MINE_TYPE, WEB_ENCODING, null);
	}
	private void loadData()
	{
		_taskArchon.executeAsyncTask(new AgreementAsyncTask());
	}
