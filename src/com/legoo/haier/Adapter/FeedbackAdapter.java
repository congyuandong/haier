...
public class FeedbackAdapter extends BaseListAdapter
{
    ...
    {   
    	...
    	{
        	view.setReadonly(Hospital.getInstance().getString(R.string.user_feedback_notreadonly));    		
    	}else if(readonly.equals(FeedbackModel.ISREADONLY))
    	{
        	view.setReadonly(Hospital.getInstance().getString(R.string.user_feedback_isreadonly));    		
    	}else
    	{
