 ...
 * @date 2014-05-07
 */
public class FeedbackAddAsyncTask extends NetworkAsyncTask 
{
	...
	public FeedbackAddAsyncTask(String name,String opinion,String suggestions,String idcard)
	{
		super();
		_name = name;
		_opinion = opinion;
	...
	{   
		...
		String url = Hospital.getInstance().getDataService().getFeedbackAdd();
		if (url != null)
		{
